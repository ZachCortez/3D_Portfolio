...
const expCards = [
  ...
  {
    review: "Zach’s growth at Coding Dojo with learning web applications have been outstanding. He approaches challenges with a problem-solving mindset.",
    imgPath: "/images/exp3.png",
    logoPath: "/images/logo3.png",
    title: "Full Stack Web Developer – Coding Dojo",
    date: "September 2020 - January 2021",
    responsibilities: [
      "Completed an intensive full-stack software development bootcamp, mastering MERN, Python, and C# stacks.",
      "Built multiple full-stack applications from scratch, applying principles of responsive design and RESTful APIs.",
      "Collaborated with peers in agile environments to debug, review, and optimize code across diverse tech stacks.",
    ],
  },
];
